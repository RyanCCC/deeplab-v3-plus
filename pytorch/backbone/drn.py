...
ref: https://arleyzhang.github.io/articles/47648ee6/
'''
...
root_url = 'http://dl.yf.io/drn/'
model_urls = {
    'resnet50': 'https://download.pytorch.org/models/resnet50-19c8e357.pth',
    'drn-c-26': root_url + 'drn_c_26-ddedf421.pth',
    'drn-c-42': root_url + 'drn_c_42-9d336e8c.pth',
    'drn-c-58': root_url + 'drn_c_58-0a53a92c.pth',
    'drn-d-22': root_url + 'drn_d_22-4bd2f8ea.pth',
    'drn-d-38': root_url + 'drn_d_38-eebb45f0.pth',
    'drn-d-54': root_url + 'drn_d_54-0e0534ff.pth',
    'drn-d-105': root_url + 'drn_d_105-12b40979.pth'
}
...
def drn_a_50(BatchNorm, pretrained=True):
    ...
    if pretrained:
        ...
        # load pretrain model
        # model_path = './checkpoints/resnet50-19c8e357.pth'
